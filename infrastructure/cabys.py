...
def search_meds(pattern: str) -> list:
    ...
    try:
        ...
        raise DatabaseError(
            error_code=DBErrorCodes.DB_CABYS_SEARCH_MEDICATION
        ) from dbae
...
def search_cabys(pattern: str) -> list:
    ...
    try:
        ...
        raise DatabaseError(
            error_code=DBErrorCodes.DB_CABYS_SEARCH_CODE) from dbae
...
def find_sacs(cabyscode: str) -> list:
    ...
    try:
        ...
        raise DatabaseError(
            error_code=DBErrorCodes.DB_CABYS_SEARCH_SACS) from dbae
...
def select(code: str):
    ...
    try:
        ...
        raise DatabaseError(
            error_code=DBErrorCodes.DB_CABYS_SELECT_CABYS_BY_CODE
        ) from dbae
