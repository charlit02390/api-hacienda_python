    ...
    try:
        ...
        try:
            ...
            raise DatabaseError(dbae.get_message(),
                                error_code=DBErrorCodes.DB_USER_CREATE) from dbae
        ...
        for cid in idcompanies:
            ...
            try:
                ...
                conn.rollback()
                raise DatabaseError(dbae.get_message(),
                                    error_code=DBErrorCodes.DB_USER_COMPANIES_LINK) from dbae
...
def modify_user(id_user, password, name, idrol, idcompanies):
    ...
    try:
        ...
        try:
            ...
            conn.rollback()
            raise DatabaseError(dbae.get_message(),
                                error_code=DBErrorCodes.DB_USER_COMPANIES_UNLINK) from dbae
        ...
        try:
            ...
            conn.rollback()
            raise DatabaseError(dbae.get_message(),
                                error_code=DBErrorCodes.DB_USER_UPDATE) from dbae
...
def delete_user_data(id_user):
    ...
    try:
        ...
        raise DatabaseError(dbae.get_message(),
                            error_code=DBErrorCodes.DB_USER_DELETE) from dbae
...
def get_user_data(id_user):
    ...
    try:
        ...
        raise DatabaseError(error_code=DBErrorCodes.DB_USER_SELECT_ONE) from dbae
    if not found_user:
...
def get_user_company_data(id_user):
    ...
    try:
        ...
        raise DatabaseError(error_code=DBErrorCodes.DB_USER_COMPANIES_SELECT_ALL) from dbae
...
def get_users():
    ...
    try:
        ...
        raise DatabaseError(error_code=DBErrorCodes.DB_USER_SELECT_ALL) from dbae
...
def verify_email(id_user):
    ...
    try:
        ...
        raise DatabaseError(error_code=DBErrorCodes.DB_USER_EMAIL_VERIFY) from dbae
...
def check_user(email, password):
    ...
    try:
        ...
        raise DatabaseError(error_code=DBErrorCodes.DB_USER_VERIFY) from dbae
